...
export class RouteGenerator {
  ...
  generate(): string {
    ...
    return [
      ...
      "import { validateJson, validateParam } from 'postgrestjs/api/middleware/validate';",
      "import { notFoundResponse } from 'postgrestjs/api/middleware/errors';",
      ...(modelHasPolicies
        ? [
            "import { assertPolicy, mergeWhere, resolvePolicyWhere } from 'postgrestjs/api/auth/policy';",
          ]
        : []),
      `import {`,
